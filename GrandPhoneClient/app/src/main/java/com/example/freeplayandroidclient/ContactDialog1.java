...
public class ContactDialog1 extends DialogFragment implements View.OnClickListener {
    private EditText userName, userEmail, userPassword,
            passwordConfirm, userTelephone;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.contact_dialog1, null);
